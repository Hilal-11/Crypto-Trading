...
function Footer() {
  return (
    <footer
      className="bg-gradient-to-r from-slate-900 to-slate-700 text-center lg:text-left">
      <div
        className="flex items-center justify-center border-b-2 border-neutral-200 p-6 lg:justify-between text-white font-bold">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            <h6
              className="text-3xl bg-gradient-to-r from-red-500 to-orange-500 p-6 text-center text-transparent bg-clip-text font-bold mb-4 flex items-center justify-center font-semibold uppercase md:justify-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
            ...
            <p className='text-white'>
             ...
             Discover real-time insights, advanced tools, and secure transactions.
              elit.
            </p>
          </div>
          <div className="">
      ...
      <div className="bg-gradient-to-r from-red-500 to-orange-500 p-6 text-center">
        ...
        <a
          className="font-semibold text-neutral-600 dark:text-neutral-900"
          href="#"
        >Millionear.com</a>
      </div>
    </footer>
