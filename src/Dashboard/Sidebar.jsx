...
function Sidebar({openSidebarToggle, OpenSidebar}) {
  return (
    <aside id="sidebar" className={openSidebarToggle ? " sidebar-responsive rounded-tr-[40px] rounded-br-[40px] lg:rounded-none relative lg:ring-0 lg:shadow-2xl lg:shadow-zinc-950  w-[70%] lg:w-[16%] ring-1 shadow-xl shadow-slate-950  my-[2.4rem] lg:-my-10": ""}>
